...
const SLIDES = [
  {
    ...
    description: "Coverage up to ₹5 lakh per family per year for hospitalization across 25,000+ hospitals.",
    cta: "Learn More",
  ...
  },
  {
    ...
    description: "Comprehensive maternal health support with reminders, nutrition tracking & emergency SOS services.",
    cta: "Get Started",
    link: "/hirkani",
    image: "https://images.unsplash.com/photo-1575321755462-9d58baca58c3?w=800&fit=crop",
  ...
  },
  {
    ...
    description: "Specialized care and assistive support for differently-abled citizens with priority services.",
    cta: "Explore Services",
    link: "https://divyangsahayak.maharashtra.gov.in/",
    image: "https://images.unsplash.com/photo-1582213782170-e120ce5e6228?w=800&fit=crop",
  ...
  },
  {
    ...
    description: "Complete vaccination tracking for children & adults with schedule reminders and certificates.",
    cta: "View Schedule",
    link: "https://nhm.maharashtra.gov.in/",
    image: "https://images.unsplash.com/photo-1589006664254-d5cf6dd20b44?w=800&fit=crop",
  ...
  return (
    <div className="relative w-full mt-12">
      ...
      >
        ...
        {/* Gradient Overlay */}
        <div className={`absolute inset-0 bg-gradient-to-r ${SLIDES[current].gradient} opacity-[0.93] mix-blend-screen bg-blend-soft-light`} />
